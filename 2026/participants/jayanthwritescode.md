...
Hi! I'm Jayanth, a second-year AI/ML student at MUJ, also pursuing a BS from IIT Madras. I built a custom Wagtail site this week to get familiar with the stack, and I maintain production content sites used by thousands of students. I'm applying for the Demo Website Redesign #566. Looking forward to contributing!

## Profile Links

| Platform | Link |
|----------|------|
| GitHub | [github.com/jayanthwritescode](https://github.com/jayanthwritescode) |
| X (Twitter) | [x.com/Techsawyer25](https://x.com/Techsawyer25) |
| LinkedIn | [linkedin.com/in/jayanthneelaiahgari](https://linkedin.com/in/jayanthneelaiahgari) |
| Personal Website | [jayanth-terminal.netlify.app](https://jayanth-terminal.netlify.app) |
...
- [x] Go through Django's [Getting started documentation and tutorial](https://docs.djangoproject.com/en/stable/intro/), until part 7.
  - Project: [django-intro](https://github.com/jayanthwritescode/django-intro)
- [x] Go through Wagtail's Getting started tutorial: [Your first Wagtail site](https://docs.wagtail.org/en/stable/getting_started/tutorial.html)
  - Project: [wagtail-intro](https://github.com/jayanthwritescode/wagtail-intro)
