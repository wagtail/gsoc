...
Super excited to join this thread! Soma here from Bengaluru, working with Python, Django and Wagtail, and I’ve already sketched a richer demo idea that can showcase Wagtail’s key features in one coherent project for a potential GSoC 2026 proposal. looking forward to working with all of you.

## Links

- GitHub profile : [SOMASEKAR17](https://github.com/SOMASEKAR17/)
...
- [ ] Join [our Slack community workspace](http://github.com/wagtail/wagtail/wiki/Slack). {do not have the email specified}
