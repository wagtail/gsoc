...
My name is Ankit Chaudhary currently in my 2nd year of B-Tech (Information Technology). I am a Full-Stack developer and have solid experience with tools and frameworks like: **Django** and **ReactJS**. 

I love to make some cool and scalable projects. I am learning django for a while now, and for past few months learning and contributing to Open-Source Codebases.

I have made some contribution to **Wagtail Codebase**  and learning something new from each contribution.

I am applying for **GSOC 2026** with Wagtail, specifically **Starter Kit Upgrade** project, and looking forward to make meaningful contribution to the community.
...
- [<u> Official Wagtail Starting Guide </u>](https://docs.wagtail.org/en/stable/getting_started/tutorial.html) — Introduction to Wagtail
- [<u> Official Wagtail Tutorial </u>](https://docs.wagtail.org/en/stable/tutorial/index.html) — Detailed documentation on Wagtail fundamentals
- [<u> Setting up development environment guide </u>](https://docs.wagtail.org/en/stable/contributing/developing.html) — Guide to setup Wagtail locally for contribution
- [<u> Official Wagtail Github </u>](https://github.com/wagtail/wagtail) — Official Wagtail source-code

### Project Description
I'm interested in **Starter Kit Upgrade** project. Because, I think it aligns perfectly with my career goals as a **Django Developer**. 

I have cloned and exploring the codebase, I am excited to work on it and make it more beginner-friendly and implement the latest Wagtail features.
...
- [Github](https://github.com/Coder-Ankit001)
- [LinkedIn](https://www.linkedin.com/in/ankit-chaudhary-a3a36b374/)
- [StackOverflow](https://stackoverflow.com/users/32078662/ankit-chaudhary)