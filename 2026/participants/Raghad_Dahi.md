...
Hey, I am Raghad from Egypt a CS student who loves trying new things (tech stacks, programming language).

worked with C, C++, Python, Bash, CMake, Git, Sql.

currently I have started learning Django to contribute to wagtail, here are some stuff that I built with Django and Wagtail:
 - https://github.com/Raghaddahi/django-polls
 - https://github.com/Raghaddahi/myportfolio
 
 And I am excited to go deeper.
...
- [x] Go through Django's [Getting started documentation and tutorial](https://docs.djangoproject.com/en/stable/intro/), until part 7.  
  → Django tutorial project repository: [Django Match Poll](https://github.com/Raghaddahi/django-polls)
- [x] Go through Wagtail's Getting started tutorial: [Your first Wagtail site](https://docs.wagtail.org/en/stable/getting_started/tutorial.html)  
  → My portfolio done with Wagtail: [My portfolio](https://raghaddahi.pythonanywhere.com/)
...
- [x] Pick up and address an [existing issue](https://github.com/wagtail/bakerydemo/issues).  
  → PR: https://github.com/wagtail/bakerydemo/pull/622  
  → PR: https://github.com/wagtail/bakerydemo/pull/632
- [ ] Write and share an AI [agent skill](https://agentskills.io/) to help with future maintenance of the project.


## Research
- https://deepwiki.com/wagtail/bakerydemo/1-overview
- https://saashammer.com/blog/create-wagtail-project
